...
temp_path = f"{mount_point_gold}/player_valuations_cleaned_temp/"
final_path = f"{mount_point_gold}/player_valuations_cleaned/player_valuations_cleaned.csv"
...
display(dbutils.fs.ls(f"{mount_point_gold}/player_valuations_cleaned/"))
